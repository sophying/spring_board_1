...
<!-- 파일업로드 -->	  <input name="resumeFile" type="file" class="custom-file-input" id="fileInput" >
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group ">
                      	  ...
                      	  <input type="hidden" name="sPostnum" id="sPostnum" value="" >
